...
class Settlement:
	...
	#Attributes
	__settlement_id = 0
	__household_List= np.empty(250, dtype= object) #list of household objects belonging to this settlement
	__population = 0
	__num_households = 0
	__grain = 0
	...
	def __init__(self, __settlement_id, __households, __population, __num_households, __grain, __colour):
